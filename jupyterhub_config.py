...
#  Default: 'http://:8000'
c.JupyterHub.bind_url = 'http://10.10.10.178:8000'
...
#  Default: set()
c.Authenticator.allowed_users = {'saurabh'}
...
c.DockerSpawner.allowed_images = {
    "Basic (notebook)":"jupyter/scipy-notebook:latest",
    "Ultralytics + Mflow":"lakky123/ultralytics-notebook:latest",
    "Torch":"lakky123/torch-notebook:latest",
    "Data Science":"docker.io/jupyter/datascience-notebook:latest",
    "All Spark(Scala, R and Spark)":"jupyter/all-spark-notebook:latest",
    "TensorFlow":"jupyter/tensorflow-notebook:latest",
    "PySpark":"docker.io/jupyter/pyspark-notebook:latest",
    }
...
#  Default: 'quay.io/jupyterhub/singleuser:5.2'
# c.DockerSpawner.container_image = 'quay.io/jupyterhub/singleuser:5.2'
...
#  Default: 'quay.io/jupyterhub/singleuser:5.2'
# c.DockerSpawner.image = 'quay.io/jupyterhub/singleuser:5.2'
...
# c.SystemUserSpawner.container_image = 'quay.io/jupyterhub/singleuser:5.2'
...
# c.SystemUserSpawner.image = 'quay.io/jupyterhub/singleuser:5.2'
...
## Deprecated, use ``DockerSpawner.image``.
#  See also: DockerSpawner.container_image
# c.SwarmSpawner.container_image = 'quay.io/jupyterhub/singleuser:5.2'
...
## The image to use for single-user servers.
#  See also: DockerSpawner.image
# c.SwarmSpawner.image = 'quay.io/jupyterhub/singleuser:5.2'
